import FilterSelectListType from '../ABSFilterPanel/enums/FilterSelectListType';
import FilterSectionConfig from '../ABSFilterPanel/dto/FilterSectionConfig';

export function updateFilterDataState(filterData: FilterSectionConfig[], sectionKey: number, itemIndex: number): any[] {
