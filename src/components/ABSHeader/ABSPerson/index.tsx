...
import { IUser, ISiteMenu } from '../../../abs/services/auth/authService';
import './index.less';
...
class ABSPerson extends React.Component<IProps, IState> {
  ...
  render() {
    ...
    const popoverContent =
      menu && menu.children
        ? menu.children.map((element: ISiteMenu) => {
    ...
    return (
      <div className="abs-person">
        <div className="abs-menu">
          <Menu
            selectedKeys={[thirdSelectKey]}
            mode="horizontal"
            onOpenChange={e => this.menuOpenChange(e)}
          >
            <SubMenu
              className="abs-menu-submenu-popup abs-person-popup"
              key={menu ? menu.key : ''}
              title={
                <div className="abs-menu-submenu">
                  <div className="abs-menu-submenu-title">
                    ...
                    <div className="abs-person-name">{userName}</div>
                    <i className="fc fc-direction-down" />
                    <div
                      className={Menuhelper.getArrowClassName(
                        menu ? menu.key : '',
                        firstSelectKey,
